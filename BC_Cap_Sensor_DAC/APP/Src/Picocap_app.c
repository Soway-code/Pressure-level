...
* 创建日期   : 2020-05-18
* 作者       : 杨春林
* 功能       : Pcap设备初始化,本函数被rt_device_register注册后,被
...
* 创建日期   : 2020-05-18
* 作者       : 杨春林
* 功能       : Pcap设备打开,本函数被rt_device_register注册后,被
*              rt_device_open调用
...
* 创建日期   : 2020-05-18
* 作者       : 杨春林
* 功能       : Pcap设备关闭,本函数被rt_device_register注册后,被
*              rt_device_close调用
* 输入参数   : dev:设备句柄;
* 输出参数   : 无
* 返回结果   : RT_EOK:设备关闭成功; 
...
* 创建日期   : 2020-05-18
* 作者       : 杨春林
* 功能       : Pcap设备读数据,本函数被rt_device_register注册后,被
*              rt_device_read调用
* 输入参数   : dev:设备句柄;
*              pos:读取数据偏移量;
...
* 创建日期   : 2020-05-18
* 作者       : 杨春林
* 功能       : Pcap设备控制,本函数被rt_device_register注册后,被
*              rt_device_control调用
* 输入参数   : dev:设备句柄;
